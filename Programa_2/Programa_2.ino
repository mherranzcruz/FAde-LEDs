...
**                                                              **
** NOM:Martin Herranz                          Data:20/05/2018  **
*****************************************************************/
//****************************INCLUDE*****************************
...
void loop() {                 //Inicia el bucle del programa
  ...
  analogWrite(led0, 90);    // posar PWM del pin 3 a 125
  analogWrite(led1, 30);    // posar PWM del pin 5 a 125
  ...
  analogWrite(led0, 125);    // posar PWM del pin 3 a 255
  analogWrite(led1, 90);    // posar PWM del pin 5 a 255
  analogWrite(led2, 30);    // posar PWM del pin 6 a 255
  ...
  analogWrite(led0, 150);    // posar PWM del pin 3 a 125
  analogWrite(led1, 125);    // posar PWM del pin 5 a 125
  analogWrite(led2, 90);    // posar PWM del pin 6 a 125
  analogWrite(led3, 30);    // posar PWM del pin 9 a 125
  analogWrite(led4, 0);    // posar PWM del pin 10 a 125
  analogWrite(led5, 0);    // posar PWM del pin 11 a 125
  ...
  analogWrite(led1, 150);     // posar PWM del pin 5 a 60
  analogWrite(led2, 125);     // posar PWM del pin 6 a 60
  analogWrite(led3, 90);     // posar PWM del pin 9 a 60
  ...
  analogWrite(led2, 150);     // posar PWM del pin 6 a 60
  analogWrite(led3, 125);     // posar PWM del pin 9 a 60
  analogWrite(led4, 90);     // posar PWM del pin 10 a 60
  ...
  analogWrite(led3, 150);     // posar PWM del pin 9 a 60
  analogWrite(led4, 125);     // posar PWM del pin 10 a 60
  analogWrite(led5, 90);     // posar PWM del pin 11 a 60
  ...
  analogWrite(led4, 150);     // posar PWM del pin 10 a 60
  ...
  analogWrite(led5, 150);     // posar PWM del pin 11 a 60
